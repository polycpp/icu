...
This branch builds **ICU 74** (defaults to release-74-2). To use a different
patch version, pass `-DICU_VERSION=74.1`. For other major versions, see the
...
|--------|---------|-------------|
| `ICU_VERSION` | `74.2` | ICU release version to fetch (e.g. `74.1, 74.2`) |
